...
def nextflow_runtime(
    ...
    enable_filter: typing.Optional[bool],
    filter_trimmed: typing.Optional[bool],
    filter_with_kraken2: typing.Optional[bool],
    skip_blastn: typing.Optional[bool],
    ...
    kraken2db: typing.Optional[str],
    kraken2confidence: typing.Optional[float],
    cutoff_tax2filter: typing.Optional[int],
    cutoff_tax2keep: typing.Optional[float],
    cutoff_unclassified: typing.Optional[float],
    tax2filter: typing.Optional[str],
    blast_coverage: typing.Optional[float],
    blast_evalue: typing.Optional[float],
    blast_identity: typing.Optional[float],
    ...
    saveReference: typing.Optional[bool],
) -> None:
    try:
...
def nf_nf_core_detaxizer(
    ...
    igenomes_base: typing.Optional[LatchDir],
    multiqc_methods_description: typing.Optional[str],
    kraken2db: typing.Optional[str] = "https://genome-idx.s3.amazonaws.com/kraken/k2_standard_08gb_20231009.tar.gz",
    kraken2confidence: typing.Optional[float] = 0.05,
    cutoff_tax2filter: typing.Optional[int] = 2,
    cutoff_tax2keep: typing.Optional[float] = 0.5,
    cutoff_unclassified: typing.Optional[float] = 0.0,
    tax2filter: typing.Optional[str] = "Homo",
    blast_coverage: typing.Optional[float] = 40.0,
    blast_evalue: typing.Optional[float] = 0.01,
    blast_identity: typing.Optional[float] = 40.0,
    reads_minlength: typing.Optional[int] = 0,
    fastp_qualified_quality: typing.Optional[int] = 0,
    fastp_cut_mean_quality: typing.Optional[int] = 15,
    genome: typing.Optional[str] = "GRCh38",
    saveReference: typing.Optional[bool] = True,
) -> None:
    """
    nf-core/detaxizer
    ...
    nextflow_runtime(
        ...
        filter_trimmed=filter_trimmed,
        filter_with_kraken2=filter_with_kraken2,
        skip_blastn=skip_blastn,
        save_intermediates=save_intermediates,
        kraken2db=kraken2db,
        kraken2confidence=kraken2confidence,
        cutoff_tax2filter=cutoff_tax2filter,
        cutoff_tax2keep=cutoff_tax2keep,
        cutoff_unclassified=cutoff_unclassified,
